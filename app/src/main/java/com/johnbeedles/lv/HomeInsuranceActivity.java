...
public class HomeInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent carsIntent = new Intent(HomeInsuranceActivity.this, HomeInsuranceActivity.class);
        ...
        home.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(HomeInsuranceActivity.this, HomeInsuranceActivity.class);
        ...
        pet.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent petIntent = new Intent(HomeInsuranceActivity.this, PetInsuranceActivity.class);
        ...
        member.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent memberIntent = new Intent(HomeInsuranceActivity.this, MemberOffersActivity.class);
