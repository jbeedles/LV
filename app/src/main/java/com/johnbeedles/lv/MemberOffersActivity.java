    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent carsIntent = new Intent(MemberOffersActivity.this, MemberOffersActivity.class);
        ...
        home.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(MemberOffersActivity.this, HomeInsuranceActivity.class);
        ...
        pet.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent petIntent = new Intent(MemberOffersActivity.this, PetInsuranceActivity.class);
        ...
        member.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent memberIntent = new Intent(MemberOffersActivity.this, MemberOffersActivity.class);
