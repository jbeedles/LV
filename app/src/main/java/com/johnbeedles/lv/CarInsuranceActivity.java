    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent carsIntent = new Intent(CarInsuranceActivity.this, CarInsuranceActivity.class);
        ...
        home.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(CarInsuranceActivity.this, HomeInsuranceActivity.class);
        ...
        pet.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent petIntent = new Intent(CarInsuranceActivity.this, PetInsuranceActivity.class);
        ...
        member.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent memberIntent = new Intent(CarInsuranceActivity.this, MemberOffersActivity.class);
